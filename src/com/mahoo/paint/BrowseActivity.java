...
public class BrowseActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Serializable serializable = bundle.getSerializable("com.mahoo.paint.BitmapPath");	
		fileList = (ArrayList<String>)serializable;
		int position = bundle.getInt("com.mahoo.paint.Position", 0);
		...
		browseeditbtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.putExtra("com.mahoo.paint.BackgroundBitmapPath",
