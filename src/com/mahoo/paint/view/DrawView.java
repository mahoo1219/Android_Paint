package com.mahoo.paint.view;

import com.mahoo.paint.DrawActivity;
import com.mahoo.paint.R;
import com.mahoo.paint.geometry.BasicGeometry;
import com.mahoo.paint.sticker.StickerBitmap;
import com.mahoo.paint.sticker.StickerBitmapList;
import com.mahoo.paint.undoandredo.UndoAndRedo;
...
public class DrawView extends View implements Runnable 
{
	...
	public boolean onTouchEvent(MotionEvent event) {
		if(event.getAction() == MotionEvent.ACTION_DOWN) {
			...
			switch(touchType) {
			case 1:touchLayer = TouchLayer.STICKER_TOOL;return true;//点击了贴图的工具
			case 0:touchLayer = TouchLayer.STICKER_BITMAP;break;//点击了贴图
			case -1:
