...
import com.mahoo.paint.AboutActivity;
import com.mahoo.paint.DrawActivity;
import com.mahoo.paint.MainActivity;
import com.mahoo.paint.PreviewActivity;
import com.mahoo.paint.R;
import com.mahoo.paint.WebActivity;
		...
		if(x > leftTopP.x && y > leftTopP.y && x < (leftTopP.x + 3 * DRAWUNIT) &&
		   y < (leftTopP.y + 3 * DRAWUNIT)) {
			...
			AlertDialog.Builder builder = new AlertDialog.Builder(context)
	   		 .setIcon(drawable.ic_dialog_alert).setMessage("确定退出?")
